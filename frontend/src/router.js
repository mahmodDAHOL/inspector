...
const routes = [
  ...
  { path: '/', name: 'Landing', component: () => import('./views/LandingPage.vue'), meta: { public: true, allowAuthenticated: true } },
  ...
  { path: '/admin', name: 'Admin', component: () => import('./views/AdminPanel.vue'), meta: { requiresAuth: true } },
...
router.beforeEach((to, from, next) => {
  ...
  if (to.meta.public && token && !to.meta.allowAuthenticated) return next('/dashboard')
  next()
})
