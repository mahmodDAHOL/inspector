...
const routes = [
  ...
  { path: '/admin', name: 'Admin', component: () => import('./views/AdminPanel.vue'), meta: { requiresAuth: true, roles: ['admin', 'super_admin'] } },
...
router.beforeEach((to, from, next) => {
  ...
  if (to.meta.roles && !to.meta.roles.includes(currentRole())) return next('/dashboard')
  next()
})
